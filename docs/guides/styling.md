...
> **Tipp:** Auf [demo.geostyler.org](https://demo.geostyler.org/) koennen Styles interaktiv zwischen allen Formaten konvertiert werden — ideal zum Erstellen und Testen von GeoStyler-JSON.
